...
Route::middleware(['auth'])->group(function () {
    ...
    //Fornt end
    Route::get('/product/details/{id}/{slug}', [UserController::class, 'ProductDetails']);
    Route::get('/vendor/details/{id}', [UserController::class, 'VendorDetails'])->name('vendor.details');
    Route::get('/vendor/all', [UserController::class, 'VendorAll'])->name('vendor.all');
    Route::get('/product/category/{id}/{slug}', [UserController::class, 'CatWiseProduct']);
    Route::get('/product/subcategory/{id}/{slug}', [UserController::class, 'SubCatWiseProduct']);
    Route::get('/product/view/modal/{id}', [UserController::class, 'ProductViewAjax']);
});
